...
//		localhost：8080请自行替换成你的ip地址  message.setContent("<h2>这是一封xx网站账号注册激活邮件，确认激活请点击以下超链接：</h2><h3><a href='http://localhost:8080/regist_web/ActiveServlet?code="+code+"'>http://localhost:8080/regist_web/ActiveServlet?code="+code+"</a></h3>", "text/html;charset=utf-8");
		message.setContent("<h2>这是一封xx网站账号注册激活邮件，确认激活请点击以下超链接：</h2><h3><a href='http://localhost：8080/regist_web/Check.jsp?code="+code+"'>http://172.16.29.245:8080/regist_web/Check.jsp?code="+code+"</a></h3>", "text/html;charset=utf-8");
